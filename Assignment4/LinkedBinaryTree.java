...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
	...
	/**
	 * sizeHelper method accepts a node, then counts and returns the number of nodes including that node.
	 * @param root
	 * @return
	 */
	...
	{
		ArrayUnorderedList<T> holder = new ArrayUnorderedList<T>();
		inOrder(root,holder);
		
		Iterator<T> iter = holder.iterator();
		
		
		while(iter.hasNext())
		{
			if(iter.next() == targetElement)
				return true;
		}
	...
	{
		ArrayUnorderedList<T> treeList = new ArrayUnorderedList<T>();
